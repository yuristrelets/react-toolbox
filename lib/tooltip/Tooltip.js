...
var Tooltip = function Tooltip(ComposedComponent) {
  ...
  return _temp2 = _class = function (_React$Component) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            other = _objectWithoutProperties(_props, ['children', 'className', 'tooltip', 'tooltipPosition', 'tooltipDelay', 'tooltipHideOnClick']);
        ...
        var tooltipClassName = (0, _classnames2.default)(_style2.default.tooltip, (_ClassNames = {}, _defineProperty(_ClassNames, _style2.default.active, active), _defineProperty(_ClassNames, _style2.default[tooltipPosition], true), _ClassNames));
    ...
    tooltipPosition: _react2.default.PropTypes.oneOf([POSITION_TOP, POSITION_BOTTOM])
  }, _class.defaultProps = {
    className: '',
    tooltipDelay: 0,
