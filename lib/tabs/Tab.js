...
var TabHeader = function (_React$Component) {
  ...
  function TabHeader() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TabHeader.__proto__ || Object.getPrototypeOf(TabHeader)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (event) {
      if (!_this.props.disabled && _this.props.onClick) {
        _this.props.onClick(event);
      }
    }, _this.handleRemove = function (event) {
      if (!_this.props.disabled && _this.props.onRemove) {
  ...
  _createClass(TabHeader, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.label,
        this.props.allowRemove ? _react2.default.createElement(_IconButton2.default, {
          icon: 'cancel',
          className: _style2.default.remove,
...
TabHeader.propTypes = {
  ...
  removeButtonTitle: _react2.default.PropTypes.string,
