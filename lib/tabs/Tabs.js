...
var Tabs = function (_React$Component) {
  ...
  function Tabs() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var lastIdx = _this.refs.navigation.children.length - 2;

      if (lastIdx < 0) return null;

      var navRect = _this.refs.navigation.getBoundingClientRect();
      var lastChildRect = _this.refs.navigation.children[lastIdx].getBoundingClientRect();
...
Tabs.propTypes = {
  ...
  arrowsClassName: _propTypes2.default.string,
  disableAnimatedBottomBorder: _propTypes2.default.bool,
  addTabButtonTitle: _propTypes2.default.string,
  addTabButtonDisabled: _propTypes2.default.bool,
