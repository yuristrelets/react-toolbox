  ...
  _createClass(Tabs, [{
    ...
    value: function updatePointer(idx) {
      ...
      this.pointerTimeout = setTimeout(function () {
        ...
        var left = rect ? rect.left - startPoint : 0;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.onAddTab ? _react2.default.createElement(_IconButton2.default, { className: _style2.default.add, icon: 'add', onClick: this.props.onAddTab }) : null
        ),
